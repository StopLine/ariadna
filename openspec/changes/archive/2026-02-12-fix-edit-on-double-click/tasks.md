...
- [x] 5.2 Протестировать двойной клик на caption в Extension Development Host
- [x] 5.3 Протестировать двойной клик на комментарии в Extension Development Host
- [x] 5.4 Протестировать одинарный клик (не должен открывать редактор)
- [x] 5.5 Протестировать два клика с интервалом > 300ms (не должен открывать редактор)
